---
name: autoabsmap-pipeline-run
description: >-
  Run the autoabsmap parking slot pipeline end-to-end on a GeoTIFF or ROI.
...
```python
from autoabsmap.config.settings import AbsmapSettings
...
from autoabsmap.pipeline.models import PipelineRequest
...
```python
from autoabsmap.export.geojson import write_geojson
