"""Straighten endpoint — click one slot, get corrected row geometries.
...
async def straighten_row(job_id: str, request: StraightenRequest) -> dict:
    ...
    Calls RowStraightener from autoabsmap/alignment_tool/.
    """
    ...
    # TODO: integrate RowStraightener once fully implemented
    from autoabsmap.alignment_tool.straightener import RowStraightener
    straightener = RowStraightener()
    corrected = straightener.straighten(request.slot_id, result.slots)
