...
1. **Grouper en rangées** dans les deux espaces — DBSCAN sur la projection perpendiculaire à l'axe dominant (même logique que `pairing/pairing_rd/line_slot_detector.py`)
