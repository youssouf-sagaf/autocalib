...
from absmap.io.atomic import write_json_atomic
from absmap.session.models import SessionTrace
...
class SessionStore:
    ...
    def save(self, trace: SessionTrace) -> Path:
        ...
        from absmap.export.geojson import geoslots_to_feature_collection
        write_json_atomic(
