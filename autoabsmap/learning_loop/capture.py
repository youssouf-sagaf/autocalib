...
def _feature_to_geoslot(feature: dict[str, Any]) -> GeoSlot:
    ...
    from autoabsmap.export.geojson import geoslot_from_feature

    return geoslot_from_feature(feature)
...
class SessionStore:
    ...
    def save_crop_artifacts(
        ...
        *,
        ...
        """Save per-crop pipeline artifacts (raw detections, post-processed).
