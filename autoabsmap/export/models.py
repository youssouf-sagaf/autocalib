...
autoabsmap → autocalib-api boundary.
"""
...
__all__ = ["SlotSource", "SlotStatus", "SlotType", "LngLat", "GeoSlot"]
...
class SlotType(str, Enum):
    """Curb slot category — aligned with backend-b2b ``ControlledSlotTypes``."""
    ...
    bus_stop = "bus_stop"
    taxi = "taxi"
    delivery_dotted = "delivery_dotted"
